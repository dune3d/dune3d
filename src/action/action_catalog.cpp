...
const std::map<ActionToolID, ActionCatalogItem> action_catalog = {
        ...
        {ActionID::VIEW_ROLL_LEFT, {"Roll left 90°", ActionGroup::VIEW, ActionCatalogItem::FLAGS_IN_TOOL}},
        {ActionID::VIEW_ROLL_RIGHT, {"Roll right 90°", ActionGroup::VIEW, ActionCatalogItem::FLAGS_IN_TOOL}},
...
const LutEnumStr<ActionID> action_lut = {
        ...
        ACTION_LUT_ITEM(VIEW_ROLL_LEFT),
        ACTION_LUT_ITEM(VIEW_ROLL_RIGHT),
