...
const std::map<ActionToolID, ActionCatalogItem> action_catalog = {
        ...
        {ActionID::VIEW_FRONT, {"Front view", ActionGroup::VIEW, ActionCatalogItem::FLAGS_IN_TOOL}},
        {ActionID::VIEW_BACK, {"Back view", ActionGroup::VIEW, ActionCatalogItem::FLAGS_IN_TOOL}},
        {ActionID::VIEW_TOP, {"Top view", ActionGroup::VIEW, ActionCatalogItem::FLAGS_IN_TOOL}},
        {ActionID::VIEW_BOTTOM, {"Bottom view", ActionGroup::VIEW, ActionCatalogItem::FLAGS_IN_TOOL}},
        {ActionID::VIEW_LEFT, {"Left view", ActionGroup::VIEW, ActionCatalogItem::FLAGS_IN_TOOL}},
        {ActionID::VIEW_RIGHT, {"Right view", ActionGroup::VIEW, ActionCatalogItem::FLAGS_IN_TOOL}},
